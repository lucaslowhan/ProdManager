...
public class RelatorioController {
    ...
    @GetMapping("/saldo-total-estoque")
    public ResponseEntity<List<RelatorioSaldoTotalEstoqueDTO>> listarSaldoTotalEstoque(){
        return ResponseEntity.ok(relatorioService.saldoTotalEstoque());
